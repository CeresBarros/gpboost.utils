## gpboost::gpb.plot.partial.dependence and related fix -- not on CRAN yet
## source: https://github.com/fabsig/GPBoost/blob/master/R-package/R/gpb.plot.partial.dependence.R
